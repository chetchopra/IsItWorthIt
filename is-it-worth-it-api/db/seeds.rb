...
cupcake = ComparisonItem.create(name: "cupcake", cost: 3.00, description: "yummy cupcake", img_url: "🧁")
coffee = ComparisonItem.create(name: "coffee", cost: 5.00, description: "caffeinated drink", img_url: "☕️")
sake = ComparisonItem.create(name: "sake", cost: 1.00, description: "Japanese liquor", img_url: "🍶")
pencil = ComparisonItem.create(name: "pencil", cost: 0.10, description: "writing stick", img_url: "✏️")
toilet_paper = ComparisonItem.create(name: "toilet paper", cost: 0.60, description: "butt wiper", img_url: "🧻")
